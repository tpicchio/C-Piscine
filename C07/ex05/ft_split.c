...
int	ft_check_separator(char *str, char *charset, int cont_str)
{
	int	i;
...
char	**ft_split(char *str, char *charset)
{
	...
	while (str[cont_str])
	{
		if (ft_check_separator(str, charset, cont_str) == 0)
		{
...
int main()
{
	char	*str = "1 12 123 1234 12345 123456 1234567 12345678 123456789 12345678 1234567 			123456 12345 1234 123 12 1";
